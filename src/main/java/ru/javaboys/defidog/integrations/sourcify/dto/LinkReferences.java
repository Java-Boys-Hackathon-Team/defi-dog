 ...
 */
@JsonPropertyOrder({
  LinkReferences.JSON_PROPERTY_ID
})
...
public class LinkReferences {
  ...
  private Map<String, Map<String, List<LinkReference>>> id = new HashMap<>();

  public LinkReferences() {
  }

  public LinkReferences id(Map<String, Map<String, List<LinkReference>>> id) {
    
    this.id = id;
    return this;
  }

  public LinkReferences putIdItem(String key, Map<String, List<LinkReference>> idItem) {
    if (this.id == null) {
      this.id = new HashMap<>();
    }
  ...
  public Map<String, Map<String, List<LinkReference>>> getId() {
    return id;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setId(Map<String, Map<String, List<LinkReference>>> id) {
    this.id = id;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinkReferences linkReferences = (LinkReferences) o;
    return Objects.equals(this.id, linkReferences.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinkReferences {\n");
